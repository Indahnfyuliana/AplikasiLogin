...
/* Comment: Membuat variabel untuk setiap element
*/
...
loginFormElement.addEventListener('submit', function(event) {
    ...
    /*Comment: Memastikan bahwa nilai email dan password sesuai dengan email yang tersimpan*/
    if (email == expectedEmail && password == expectedPassword){

      /*Comment: Jika sesuai maka program akan berpindah ke halaman home*/
      goToHome();

      /* Comment: Jika salah maka program akan menampilkan informasi bahwa input salah*/
    } else{
      showPopUp();
    }
});
